package com.upt.firebasestorage;
...
public class MainActivity extends AppCompatActivity {
    ...
    StorageReference storageRef = storage.getReferenceFromUrl("gs://storage-bdfab.appspot.com").child("civil_war.jpg");
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mBtn_subir.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                StorageReference storageReference = storage1.getReferenceFromUrl("gs://storage-bdfab.appspot.com").child("ic_launcher.png");
